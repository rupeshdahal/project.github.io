                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        @php
                            $settings=DB::table('settings')->get();
                        @endphp
                        <a href="{{route('home')}}"><img src="@foreach($settings as $data) {{get_image_url('setting',$data->logo)}} @endforeach" width="100" height="100" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
...
{{--                                            <li class="{{Request::path()=='about-us' ? 'active' : ''}}"><a href="{{route('about-us')}}">About Us</a></li>--}}
                                            <li class="@if(Request::path()=='product-grids'||Request::path()=='product-lists')  active  @endif"><a href="{{route('product-grids')}}">Products</a>
