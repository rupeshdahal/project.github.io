        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        @if($profile->photo)
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{get_image_url('user',$profile->photo)}}" alt="profile picture">
                        @else
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" enctype="multipart/form-data" method="POST" action="{{route('profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                        <label for="inputPhoto" class="col-form-label">Profile Image <span class="text-danger">*</span></label>
