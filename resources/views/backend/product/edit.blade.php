    ...
    <div class="card-body">
      <form method="post" enctype="multipart/form-data" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="price" type="number"  min="0" name="price" placeholder="Enter price"  value="{{$product->price}}" class="form-control">
          @error('price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          @if($product->photo)
              ...
              @endphp
              <p>Existing Image</p>
              <img src="{{get_image_url('product',$photo[0])}}" height="160" width="160" alt="">
          @endif
